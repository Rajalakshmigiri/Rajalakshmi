...
const Register = () => {
    ...
    return (
        ...
        <div className='flex items-center justify-center m-auto my-2 '>
            {userLoggedIn && (<Navigate to={'/home'} replace={true} />)}

            <div className='bg-slate-200 border border-slate-400 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-30 relative mx-auto my-20'>
